...
namespace RuntimeMetadata
{
    ...
    {
        public class BaseEventGenBuilder : ModulesBuilder
        {
            private BaseEventGenBuilder(uint id, PalletModule[] modules, Dictionary<uint, (string, List<string>)> typeDict, Dictionary<uint, NodeType> nodeTypes) :
                base(id, modules, typeDict, nodeTypes)
            {
            }

            public static BaseEventGenBuilder Init(uint id, PalletModule[] modules, Dictionary<uint, (string, List<string>)> typeDict, Dictionary<uint, NodeType> nodeTypes)
            {
                return new BaseEventGenBuilder(id, modules, typeDict, nodeTypes);
            }

            public override BaseEventGenBuilder Create()
            {
                #region CREATE
