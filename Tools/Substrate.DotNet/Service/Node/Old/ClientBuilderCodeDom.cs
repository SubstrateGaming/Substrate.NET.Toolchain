...
{
   public class ClientBuilderCodeDom : ClientBuilderBaseCodeDom
   {
      private ClientBuilderCodeDom(string projectName, uint id, List<string> moduleNames, NodeTypeResolver typeDict) :
          base(projectName, id, moduleNames, typeDict)
      {
      }

      public static ClientBuilderCodeDom Init(string projectName, uint id, List<string> moduleNames, NodeTypeResolver typeDict)
      {
         return new ClientBuilderCodeDom(projectName, id, moduleNames, typeDict);
      }

      public override ClientBuilderCodeDom Create()
      {
