...
{
   public class ArrayBuilderCodeDom : TypeBuilderBaseCodeDom
   {
      public static int Counter = 0;

      private ArrayBuilderCodeDom(string projectName, uint id, NodeTypeArray typeDef, NodeTypeResolver typeDict)
      ...
      public static ArrayBuilderCodeDom Create(string projectName, uint id, NodeTypeArray nodeType, NodeTypeResolver typeDict)
      {
         return new ArrayBuilderCodeDom(projectName, id, nodeType, typeDict);
      }
      ...
      public override TypeBuilderBaseCodeDom Create()
      {
         ...
         CodeMemberMethod encodeMethod = ArrayBuilderCodeDom.GetEncode();
         targetClass.Members.Add(encodeMethod);

         CodeMemberMethod decodeMethod = ArrayBuilderCodeDom.GetDecode(fullItem.ToString());
