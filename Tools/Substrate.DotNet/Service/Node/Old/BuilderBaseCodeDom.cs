...
{
   public abstract class BuilderBaseCodeDom
   {
      ...
      public abstract BuilderBaseCodeDom Create();

      public BuilderBaseCodeDom(string projectName, uint id, NodeTypeResolver resolver)
      {
