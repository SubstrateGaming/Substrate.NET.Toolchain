...
{
   public class EnumBuilderCodeDom : TypeBuilderBaseCodeDom
   {
      private EnumBuilderCodeDom(string projectName, uint id, NodeTypeVariant typeDef, NodeTypeResolver typeDict)
          : base(projectName, id, typeDef, typeDict)
      {
      }

      public static EnumBuilderCodeDom Init(string projectName, uint id, NodeTypeVariant typeDef, NodeTypeResolver typeDict)
      {
         return new EnumBuilderCodeDom(projectName, id, typeDef, typeDict);
      }
