...
{
   public class RestServiceStorageModuleBuilderCodeDom : ModuleBuilderBaseCodeDom
   {
      private RestServiceStorageModuleBuilderCodeDom(string projectName, uint id, PalletModule module, NodeTypeResolver typeDict, Dictionary<uint, NodeType> nodeTypes) :
          base(projectName, id, module, typeDict, nodeTypes)
      {
      }

      public static RestServiceStorageModuleBuilderCodeDom Init(string projectName, uint id, PalletModule module, NodeTypeResolver typeDict, Dictionary<uint, NodeType> nodeTypes)
      {
         return new RestServiceStorageModuleBuilderCodeDom(projectName, id, module, typeDict, nodeTypes);
      }

      public override RestServiceStorageModuleBuilderCodeDom Create()
      {
