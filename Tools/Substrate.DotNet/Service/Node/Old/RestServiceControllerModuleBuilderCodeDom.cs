...
{
   public class RestServiceControllerModuleBuilderCodeDom : ModuleBuilderBaseCodeDom
   {
      private string NetApiProjectName { get; }

      private RestServiceControllerModuleBuilderCodeDom(string projectName, string netApiProjectName, uint id, PalletModule module, NodeTypeResolver typeDict, Dictionary<uint, NodeType> nodeTypes) :
          base(projectName, id, module, typeDict, nodeTypes)
      {
         NetApiProjectName = netApiProjectName;
      }

      public static RestServiceControllerModuleBuilderCodeDom Init(string projectName, string netApiProjectName, uint id, PalletModule module, NodeTypeResolver typeDict, Dictionary<uint, NodeType> nodeTypes)
      {
         return new RestServiceControllerModuleBuilderCodeDom(projectName, netApiProjectName, id, module, typeDict, nodeTypes);
      }

      public override RestServiceControllerModuleBuilderCodeDom Create()
      {
