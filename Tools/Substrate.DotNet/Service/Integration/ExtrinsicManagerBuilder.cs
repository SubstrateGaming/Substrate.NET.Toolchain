...
{
   public class ExtrinsicManagerBuilder : IntegrationBuilderBase
   {
      private ExtrinsicManagerBuilder(string projectName, uint id, List<string> moduleNames, NodeTypeResolver typeDict) :
          base(projectName, id, moduleNames, typeDict)
      {
      }

      public static ExtrinsicManagerBuilder Init(string projectName, uint id, List<string> moduleNames, NodeTypeResolver typeDict)
      {
         return new ExtrinsicManagerBuilder(projectName, id, moduleNames, typeDict);
      }

      public override ExtrinsicManagerBuilder Create()
      {
         ClassName = "ExtrinsicManager";
...
{{
    ...
    {{
        ...
        public {ClassName}(int extrinsicTimeOut = 30, int retentationTime = 60)
        {{
