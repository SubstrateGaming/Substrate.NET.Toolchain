...
namespace Ajuna.NetApi.Model.PalletGrandpa
{
    ...
    public sealed class GrandpaCalls
    {
        ...
        /// </summary>
        public static Method ReportEquivocation(Ajuna.NetApi.Model.SpFinalityGrandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.SpSession.MembershipProof key_owner_proof)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method ReportEquivocationUnsigned(Ajuna.NetApi.Model.SpFinalityGrandpa.EquivocationProof equivocation_proof, Ajuna.NetApi.Model.SpSession.MembershipProof key_owner_proof)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(equivocation_proof.Encode());
            byteArray.AddRange(key_owner_proof.Encode());
