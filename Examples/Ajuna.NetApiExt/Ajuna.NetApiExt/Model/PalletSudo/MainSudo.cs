...
namespace Ajuna.NetApi.Model.PalletSudo
{
    ...
    public sealed class SudoCalls
    {
        ...
        /// </summary>
        public static Method Sudo(Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall call)
        {
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SudoUncheckedWeight(Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall call, Ajuna.NetApi.Model.Types.Primitive.U64 weight)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
            byteArray.AddRange(call.Encode());
        ...
        /// Contains one variant per dispatchable that can be called by an extrinsic.
        /// </summary>
        public static Method SudoAs(Ajuna.NetApi.Model.SpRuntime.EnumMultiAddress who, Ajuna.NetApi.Model.NodeRuntime.EnumNodeCall call)
        {
            System.Collections.Generic.List<byte> byteArray = new List<byte>();
    ...
    /// </summary>
    public sealed class EventKeyChanged : BaseTuple<Ajuna.NetApi.Model.SpCore.AccountId32>
    {
    }
